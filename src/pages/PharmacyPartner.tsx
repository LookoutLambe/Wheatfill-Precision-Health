            ...
            <p className="muted pharmacyToolbarSub">
              {isPrimaryCatalog ? (
                <>
                  ...
                  is <b>Venmo</b> (or <b>PayPal</b> as directed) after you submit from the summary page—the practice
                  follows up with amount and pay-to details.
                </>
              ) : (
                <>
                  This is the product list—add vials to your bag, then open <b>View cart</b> for a full summary.
                  Payment is <b>Venmo</b> or <b>PayPal</b> (as the practice instructs) after you submit from the summary
                  page; the team sends pay-to details.
                </>
              )}
            </p>
