...
- **Payments**: PayPal order total + payment status (no PAN/CVV; payment is collected on PayPal's hosted pages).
...
- payment status changes and order status changes caused by payment
